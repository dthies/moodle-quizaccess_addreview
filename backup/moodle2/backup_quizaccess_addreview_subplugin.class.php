...
/**
 * Backup code for the quizaccess_addreview plugin.
 *
...
/**
 * Provides the information to backup the addreview quiz access plugin.
 *
 ...
 */
class backup_quizaccess_addreview_subplugin extends backup_mod_quiz_access_subplugin {
    ...
    protected function define_quiz_subplugin_structure() {
        ...
        $subplugintablesettings = new backup_nested_element('quizaccess_addreview',
                null, array('addreview'));
        ...
        $subplugintablesettings->set_source_table('quizaccess_addreview',
